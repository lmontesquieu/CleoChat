...
import com.technologies.cleo.cleomove.chat.ui.adapters.ChatAdapter;
import com.technologies.cleo.cleomove.chat.ChatPresenter;
import com.technologies.cleo.cleomove.chat.ChatPresenterImpl;
import com.technologies.cleo.cleomove.domain.AvatarHelper;
...
public class ChatActivity extends AppCompatActivity implements ChatView {
    ...
    public void onMessageReceived(ChatMessage msg) {
        ...
        Log.d(TAG, String.valueOf(adapter.getItemCount() - 1));
        adapter.add(msg);
